  ...
  <body>
    ...
    <nav>
      <div class="nav-wrapper blue-grey z-depth-5">
        <a href="#" class="brand-logo right"><div class="chip">
            ...
            <div class="row contenedor">
              <div class="row col s2 menu blue-grey z-depth-5">
                ...
                <div class="row col s12 center">
                  <a class="waves-effect waves-light btn white black-text"><i class="material-icons left">add_circle_outline</i>Inicicio</a>
                </div>
                ...
                <ul class="collapsible z-depth-5">
                  <li>
                    <div class="collapsible-header">
                      ...
                      Agendar cita
                      <span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">archive</i></span></div>
                    <div class="collapsible-body white">
                      <div class="collection">
                        <a href="#!" class="collection-item black-text" onclick="mostrasDiv('calendarioCita');"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Calendario</a>
                        <a href="#!" class="collection-item black-text" onclick="mostrasDiv('cita');"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Cita</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="collapsible-body white">
                      <div class="collection">
                        <a href="#!" class="collection-item black-text" onclick="mostrasDiv('reporte');"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Registro de ventas</a>
                        <a href="#!" class="collection-item black-text"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Grafico</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="collapsible-body white">
                      <div class="collection">
                        <a href="#!" class="collection-item black-text" onclick="mostrasDiv('usuariosEdit');con.cargarUsuarios();"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Registrar/Editar</a>
                        <a href="#!" class="collection-item black-text" onclick="mostrasDiv('usuariosCont');"><span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">chevron_right</i></span>Cambiar contrasena</a>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div class="collapsible-header">
                      ...
                      Inventario
                      <span class="badge"><i class="material-icons deep-purple-text" style="font-size: 30px;">archive</i></span></div>
                    <div class="collapsible-body white center"><b><i class="material-icons deep-purple-text" style="font-size: 30px;">security</i><p>Soon...</p></b></div>
                  </li>
                </ul>
              </div>
                    ...
                    <div class="col s6">
                      <form>
                        <div class="row col s12">
                          ...
                          <div class="row">
                            <a class="btn-floating btn-large waves-effect waves-light red" onclick="ocultarDiv();"><i class="material-icons">close</i></a>
                          </div>
