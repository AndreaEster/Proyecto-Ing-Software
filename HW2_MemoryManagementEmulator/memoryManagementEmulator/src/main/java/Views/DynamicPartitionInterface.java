 ...
 */
public class DynamicPartitionInterface extends javax.swing.JInternalFrame implements InternalFrameListener{

    /**
     * Creates new form DynamicSeg
     */
    private Core.DynamicPartitionClasses.DynamicPartitionEngine dpeOS;
    ...
    public DynamicPartitionInterface() {
        initComponents();
        this.dpeOS = new Core.DynamicPartitionClasses.DynamicPartitionEngine();
    ...
    public void drawPartition(Core.DynamicPartitionClasses.Node partition, int location, List<JPanel> panelList, List<JLabel> labelList, String memory){
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        ...
        if(this.processSizeInput.getText().strip()!= ""){
            ...
            validation = Core.DynamicPartitionClasses.Validator.validateDinamycProcessSize(this.processSize, (int)this.dpeOS.getMainMemory().getMemorySize());
    ...
    private void changeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changeBtnActionPerformed
        ...
        if(this.processNumberInput.getText().strip()!= ""){
            ...
            validation = Core.DynamicPartitionClasses.Validator.validateDinamycProcessLocation(partitionNumber, this.dpeOS.getMainMemory().getNumElements());
            if(validation.equals("valid")){
